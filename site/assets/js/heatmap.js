    ...
    myMap.setMaxBounds(  [[-22,30],   [-36,20]]  )
    ...
    if (currentPage.includes('ssp245.html')) {
        console.log(test_geoData)
        features = test_geoData.features; // Replace with your spp245 feature data
        console.log("245")
